...
export default function Page() { // Renamed from MainAppContent to Page as per original file name
  ...
  const handlePlaceOrder = async (formData, cartData, onCloseCart, onPaymentSuccess) => {
    ...
    try {
      ...
      const response = await fetch("https://growlify-backend.onrender.com/api/shop/create-order", {
        method: "POST",
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          try {
            ...
            await fetch("https://growlify-backend.onrender.com/api/shop/send-confirmation", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                formData,
